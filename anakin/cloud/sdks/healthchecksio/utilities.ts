...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("healthchecksio");
			params.setVersion("2.3.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tyaXN0b2ZmZXJhaGwvaGVhbHRoY2hlY2tzaW8iLCJ2ZXJzaW9uIjoiMi4zLjAifX0="), c => c.charCodeAt(0)));
